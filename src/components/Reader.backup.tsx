              ...
              <div className="flex justify-end space-x-2 mt-3">
                ...
                >
                  ...
                  {isPlayingAudio === 'es' ? <VolumeX size={14} /> : <Volume2 size={14} />}
                    ...
                    </div>      )}            {/* Estilos de scrollbar y animaciones */}      <style jsx>{`        @keyframes fadeIn {          from { opacity: 0; }          to { opacity: 1; }        }        .animate-fade-in {          animation: fadeIn 0.3s ease-in-out;        }        .reader-fullscreen::-webkit-scrollbar {          width: 8px;        }        .reader-fullscreen::-webkit-scrollbar-track {          background: transparent;        }        .reader-fullscreen::-webkit-scrollbar-thumb {          background: rgba(156, 163, 175, 0.4);          border-radius: 10px;        }        .reader-fullscreen::-webkit-scrollbar-thumb:hover {          background: rgba(107, 114, 128, 0.5);        }      `}</style>    </div>
  );
};
